          ...
          <ul className="flex list-none">
            {[
              ...
              <li key={item.href}>
                <a
                  href={item.href}
                  className="font-cond text-xs font-bold tracking-[0.1em] uppercase text-white/80 no-underline px-[14px] h-[52px] flex items-center border-l border-white/[0.06] hover:text-white transition-colors"
                >
                  {item.label}
                </a>
              </li>
