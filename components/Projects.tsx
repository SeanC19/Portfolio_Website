...
function RosterRow({ project }: { project: Project }) {
  return (
    <div className="group grid grid-cols-[60px_1fr_180px] py-6 border-b border-[var(--border)] last:border-b-0 hover:bg-navy/[0.02] transition-colors items-start">
      {/* Number */}
      ...
      {/* Main */}
      <div className="pr-8">
        <div className="font-cond text-[1.2rem] font-black tracking-[0.02em] uppercase text-navy mb-[6px] leading-[1.1]">
          {project.title}
        </div>
    ...
    <div id="projects">
      ...
      <div className="border-b border-[var(--border)]">
        <div className="max-w-[1200px] mx-auto px-16 py-16">
          ...
          {/* Roster header */}
          <div className="fade-in grid grid-cols-[60px_1fr_180px] pb-[10px] border-b-2 border-navy mb-0">
