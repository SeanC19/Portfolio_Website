...
export const projects: Project[] = [
  
  {
    ...
    tags: ['Next.js 16', 'React', 'Vercel', 'TypeScript', 'Tailwind v4', 'CI/CD'],
    category: 'Web · Frontend · Live',
    live: true,
  ...
  },
  {
    ...
    tags: ['Next.js', 'React', 'Vercel', 'TypeScript', 'Tailwind v4', 'CI/CD', 'AWS Lambda', 'AWS SES'],
    category: 'Web · Full-Stack · Live',
    live: true,
  ...
  {
    num: '03',
    title: 'Network Attack Detection & Intrusion Analysis',
    desc: 'Deployed Snort IDS on Kali Linux and simulated ICMP, UDP, and TCP SYN flood attacks using Nmap and hping3. Authored custom detection rules achieving 100% alert accuracy and performed Wireshark packet analysis to verify spoofed IP behavior, protocol anomalies, and network-layer responses.',
    tags: ['Wireshark', 'Snort', 'Nmap', 'hping3', 'Docker', 'Kali Linux'],
    category: 'Security · Network',
  },
  {
    num: '04',
    title: 'TLS Protocol Implementation & MITM Attack Simulation',
    desc: 'Built a TLS client-server system in Python with X.509 certificate verification, SANs, and a root CA, establishing PKI trust chains verified in Firefox. Implemented a multithreaded HTTPS proxy to simulate a Man-in-the-Middle attack, intercepting encrypted traffic by exploiting a compromised CA.',
    tags: ['Python', 'Wireshark', 'OpenSSL', 'Docker', 'Kali Linux'],
    category: 'Security · Cryptography',
  },
  {
    num: '05',
    title: 'Encryption & Digital Signature Implementation',
    desc: 'Implemented a full RSA pipeline covering key generation, encryption, decryption, signing, and verification using 128-bit primes and OpenSSL. Demonstrated the avalanche effect by comparing signatures across minimally modified messages and confirmed that a 2-bit corruption fully invalidates signature verification.',
    tags: ['Python', 'OpenSSL', 'Kali Linux', 'RSA', 'PKI'],
    category: 'Security · Cryptography',
  },
  {
    num: '06',
...
export const timeline: TimelineYear[] = [
  {
    ...
    entries: [
      ...
      },
      {
        ...
        date: '2026',
        desc: 'Building on my AWS experience with Lambda, SES, and API Gateway. Currently studying for certification exam.',
        muted: true,
      },
      {
        type: 'cert',
  ...
  },
  {
    ...
    entries: [
      ...
      },
      {
        ...
        date: '2023',
        desc: 'Coursework includes Secure Programming & Systems, Software Engineering, Data Structures & Algorithms, Databases, Software Testing/Maintenance, and Mobile App Development',
      },
      {
        type: 'honor',
